...
export class AccountingService {
    ...
    // Fetches income data for chart representation based on the specified timeframe
    ...
    // Fetches request data for chart representation based on the specified timeframe
    ...
    // Determines query parameters based on the specified chart timeframe
